        ...
        {loading ? (
          ...
          <>
            ...
            {activeTab === 'university' && (() => {
              ...
              // Perform second pass adaptive keyword merging
              const mergedGroups = [];
              ...
              // Construct final presentation data with tier counts
              const uniDataList = mergedGroups.map(group => {
              ...
              let sortedUnis = uniDataList.sort((a, b) => b.total - a.total);
              
              if (univSearch) {
                sortedUnis = sortedUnis.filter(u => u.name.toLowerCase().includes(univSearch.toLowerCase()));
              }
