...
// Public anon key. Data access is governed by Row-Level Security: users sign in
// with Google (@mondee.com) and their JWT drives RLS as the `authenticated`
// role. See enable_authenticated_portal_access.sql.
...
// once a table crosses 1000 rows and the frontend drifts out of sync.
