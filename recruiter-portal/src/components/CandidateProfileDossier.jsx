            ...
            <CardContent className="pt-4 flex flex-col gap-4">
              ...
              {round === 3 && (
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex gap-2 mt-2">
                    <Button onClick={() => handleSave('Rejected', false)} variant="outline" className="flex-1 border-red-500 hover:bg-red-500/10 text-red-500 rounded-lg font-bold" disabled={saving}>
                      Rejected
                    </Button>
                    <Button onClick={() => handleSave('Hired', false)} className="flex-1 bg-green-600 hover:bg-green-700 text-white rounded-lg font-bold" disabled={saving}>
                      Hired
                    </Button>
                  </div>
                </div>
